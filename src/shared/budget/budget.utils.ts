import { MonthlyValues, createZeroYear } from '../../budget-groups/dto/budget-overview.dto';
...
export function addMonthlyValues(values1: MonthlyValues, values2: MonthlyValues): MonthlyValues {
...
export function subtractMonthlyValues(values1: MonthlyValues, values2: MonthlyValues): MonthlyValues {
  const result = createZeroYear();
  const months = Object.keys(result) as (keyof MonthlyValues)[];
